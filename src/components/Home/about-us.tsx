		...
		<div className="mt-12 px-6 md:px-28 flex flex-col-reverse items-center justify-center lg:flex-row gap-x-10 gap-y-4">
			<div className="w-full h-aboutUS-imgDiv-h md:w-aboutUS-imgDiv-w flex items-center justify-center lg:justify-start overflow-hidden">
				<div className="relative h-96 w-80 md:w-about-img-w md:h-about-img-h">
					<Image src={"/images/about-us.webp"} alt="About Us" fill objectFit="cover" />
                    <div className="">
                        
                    </div>
					<Image className="absolute -top-16 -right-16" src={"/images/about-us-top.webp"} alt="About Us"height={128} width={146} objectFit="cover" />
					<Image className="absolute -bottom-44 -right-40" src={"/images/about-us-bottom.webp"} alt="About Us"height={352} width={320} objectFit="cover" />
				</div>
			</div>
