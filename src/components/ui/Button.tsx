...
const Button: React.FC<ButtonProps> = ({
	...
	return (
		<button
			{...props}
			className={`inline-flex justify-center items-center gap-2.5 rounded-lg px-4 py-2.5 text-xs md:text-base font-medium focus:outline-none focus:ring-2 focus:ring-dark-blue focus:ring-offset-2 ${variantClasses} ${className}`}
		>
			{children}
		</button>
	);
